<template>
    ...
    <view class="normal_clock">
		...
		<!-- 页面顶部导航条 -->
		<view class="head_box">
			<uni-nav-bar :status-bar="true" @clickLeft="back_to_home" 
				leftIcon="back" backgroundColor="#c4c4e9" 
				:fixed="true" color="white" 
				rightIcon="trash-filled" @clickRight="delete_clock">
		...
		<view class="normal_clock_content">
			...
			<view class="jump_to_game_choose">
				<view class="jump_to_game_choose_block">
			...
			<view class="time_setting">
				...
				<picker-view class="time_setting_picker" v-if="visible" 
					indicator-class="time_setting_picker_indicator" 
