<template>
  <div class="layout">
    ...
    <div class="all-container">
      ...
      <div class="container" @touchstart="start" @touchend="movef" >
        <span
          class="list"
  ...
  export default {
    ...
    methods: {
		...
		movef(event){
			...
			const dx = move.changedTouches[0].clientX -  this.laststart[0].clientX;
			const dy = move.changedTouches[0].clientY -  this.laststart[0].clientY;
