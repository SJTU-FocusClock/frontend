<template>
  <view class="gg-load-more" @click="onClick">
    <!-- #ifdef APP-NVUE -->
    <loading-indicator v-if="!webviewHide && status === 'loading' && showIcon" :style="{color: color,width:iconSize+'px',height:iconSize+'px'}"
      :animating="true" class="gg-load-more__img gg-load-more__img--nvue"></loading-indicator>
    <!-- #endif -->
    <!-- #ifdef H5 -->
    <svg width="24" height="24" viewBox="25 25 50 50"
      ...
      :style="{width:iconSize+'px',height:iconSize+'px'}" class="gg-load-more__img gg-load-more__img--android-H5">
    ...
    <view v-if="!webviewHide && (iconType==='circle' || iconType==='auto' && platform === 'android') && status === 'loading' && showIcon"
      :style="{width:iconSize+'px',height:iconSize+'px'}" class="gg-load-more__img gg-load-more__img--android-MP">
    ...
    <view v-else-if="!webviewHide && status === 'loading' && showIcon" :style="{width:iconSize+'px',height:iconSize+'px'}"
      class="gg-load-more__img gg-load-more__img--ios-H5">
      <image
...
.gg-load-more__img--nvue {
  color: #666666;
}

.gg-load-more__img--android,
.gg-load-more__img--ios {
  width: 24px;
  height: 24px;
...
.gg-load-more__img--ios-H5 {
  position: relative;
  animation: loading-ios-H5 1s 0s step-end infinite;
}

.gg-load-more__img--ios-H5 > image {
  position: absolute;
  width: 100%;
  height: 100%;
  left: 0;
...
/* #ifdef H5 */
.gg-load-more__img--android-H5 {
  animation: loading-android-H5-rotate 2s linear infinite;
  transform-origin: center center;
}

.gg-load-more__img--android-H5 > circle {
...
.gg-load-more__img--android-MP > view {
  position: absolute;
...
.gg-load-more__img--android-MP > view:nth-child(1) {
  animation: loading-android-MP-1 1s 0s linear infinite;
}

.gg-load-more__img--android-MP > view:nth-child(2) {
  animation: loading-android-MP-2 1s 0s linear infinite;
}

.gg-load-more__img--android-MP > view:nth-child(3) {
