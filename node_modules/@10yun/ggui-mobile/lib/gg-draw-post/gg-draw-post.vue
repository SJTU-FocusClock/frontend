<template>
  <view>
    <canvas canvas-id="canvasdrawer" :style="{ 'width': width+'px', 'height': height+'px' }" class="gg-draw-board" v-if="showCanvas"></canvas>
  </view>
</template>
...
export default {
  ...
  methods: {
    ...
    startPainting() {
      let _this = this;
      var views = _this.painting.views;
      var tempFileList = _this.tempFileList;
            ...
            uni.getImageInfo({
              ...
              complete: res => {
                if (res.errMsg === 'getImageInfo:ok') {
                  ...
                  _this.$emit('getImage', { errMsg: 'canvasdrawer:download fail' });
      ...
      uni.canvasToTempFilePath(
        {
          ...
          complete: function (res) {
            if (res.errMsg === 'canvasToTempFilePath:ok') {
              ...
              _this.$emit('getImage', { tempFilePath: res.tempFilePath, errMsg: 'canvasdrawer:ok' });
            } else {
              _this.$emit('getImage', { errMsg: 'canvasdrawer:fail' });
            }
          }
        },
        _this
