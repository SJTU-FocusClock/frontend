    ...
    <view class="gg-cell-box">
      <view class="gg-cell-main" :class=" sublabel && 'gg-cell-main-big' " @tap="jump">
        <view class="gg-cell-main-left">
          ...
          <view class="gg-cell-main-left-text" :class="!image && !$slots.before?'gg-cell-main-left-text-noimage':''">
        ...
        <view class="gg-cell-main-center" :class="url=='' && !$listeners.click?'gg-cell-main-center-nourl':''">
